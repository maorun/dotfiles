...
nvim_lsp['tailwindcss'].setup {
    root_dir = function(fname)
        return "/Users/mdriemel/repos/ac-steam/packages/shared"
            or
            nvim_lsp.util.root_pattern('tailwind.config.js', 'tailwind.config.cjs', 'tailwind.config.mjs',
                'tailwind.config.ts', './packages/shared/tailwind.config.js')(
                fname
            ) or
            nvim_lsp.util.root_pattern('postcss.config.js', 'postcss.config.cjs', 'postcss.config.mjs',
                'postcss.config.ts')(
                fname
            ) or nvim_lsp.util.find_package_json_ancestor(fname) or nvim_lsp.util.find_node_modules_ancestor(fname) or
